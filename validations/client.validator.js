...
const clientSchema = Joi.object({
    business_name: Joi.string().empty().min(8).max(500).required().messages({
        ...
        'any.required': 'bussinesname is a required field'
      }),
      domain: Joi.string().empty().min(4).max(45).required().messages({
    ...
    email: Joi.string().empty().email().min(8).max(191).required().messages({
    ...
    phone: Joi.string().empty().min(7).max(15).required().messages({
    ...
    nif_cif: Joi.string().alphanum().empty().min(9).max(15).required().messages({
        ...
        'any.required':'nif/cif is a required field'
    }),
    address:Joi.string().empty().min(7).max(400).required().messages({
    ...
    country:Joi.string().empty().min(4).max(50).required().messages({
    ...
    state:Joi.string().empty().min(4).max(100).required().messages({
    ...
    province:Joi.string().empty().min(4).max(100).required().messages({
    ...
    town:Joi.string().empty().min(4).max(100).required().messages({
        ...
        'any.required':'town is a required field'
    }),
    id_cluster:Joi.number().empty().max(10).required().messages({
        'number.base':'id_cluster should be a type of number',
        'number.empty':'id_cluster cannot be an empty field',
        'number.max': 'id_cluster should have a max length of 10 number',
        'any.required':'id_cluster is a required field'
    }),
});
